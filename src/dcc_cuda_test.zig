...
// Embedded PTX code - IN-PLACE addition: a[i] = a[i] + b[i]
const PTX_CODE =
    \\// Generated PTX for function: gpu_vector_add
    \\// Target: SM 89
    \\// Generated by DCC emit_ptx tool using MLIR
    \\
    \\.version 8.0
    \\.target sm_50
    \\.address_size 64
    ...
    \\    .param .u64 gpu_add_kernel_param_0,
    \\    .param .u64 gpu_add_kernel_param_1
    \\)
    \\{
    \\    .reg .pred %p<2>;
    \\    .reg .f32 %f<4>;
    ...
    \\    .reg .b64 %rd<3>;
    \\
    \\    ld.param.u64 %rd1, [gpu_add_kernel_param_0];
    \\    ld.param.u64 %rd2, [gpu_add_kernel_param_1];
    \\    mov.u32 %r1, %ctaid.x;
    \\    mov.u32 %r2, %ntid.x;
    \\    mov.u32 %r3, %tid.x;
    \\    mad.lo.s32 %r4, %r1, %r2, %r3;
    \\    setp.ge.s32 %p1, %r4, 1024;
    \\    @%p1 bra LBB0_2;
    \\
...
pub fn main() !void {
    ...
    // Get kernel function
    std.debug.print("Getting gpu_vector_add kernel function...\n", .{});
