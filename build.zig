...
pub fn build(b: *std.Build) void {
    ...
    exe_mod.addImport("dcc_lib", lib_mod);
    ...
    // Add LLVM paths (from llvm-config)
    ...
    // Link LLVM for tests too
    exe_unit_tests.linkLibC();
    exe_unit_tests.linkSystemLibrary("LLVM");
    
    // Add LLVM paths for tests too
